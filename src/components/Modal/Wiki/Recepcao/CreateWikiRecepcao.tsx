...
import {
  Container,
  Wrapper
} from '../../../../styles/components/Modal/Wiki/Recepcao/CreateWikiRecepcao'

interface CreateWikiRecepcaoProps {
  id: string
  faqs: WikiRecepcaoProps[]
  setFaqs: (faqs: WikiRecepcaoProps[]) => void
}

export function CreateWikiRecepcao({
  id,
  faqs,
  setFaqs
}: CreateWikiRecepcaoProps) {
  ...
  return (
    <GlobalModal size={600} title="Cadastrar FAQ Recepção" id={id}>
