...
import {
  Container,
  Wrapper
} from '../../../../styles/components/Modal/Wiki/Financeiro/CreateWikiFinanceiro'

interface CreateWikiFinanceiroProps {
  id: string
  faqs: WikiFinanceiroProps[]
  setFaqs: (faqs: WikiFinanceiroProps[]) => void
}

export function CreateWikiFinanceiro({
  id,
  faqs,
  setFaqs
}: CreateWikiFinanceiroProps) {
  ...
  return (
    <GlobalModal size={600} title="Cadastrar FAQ Financeiro" id={id}>
